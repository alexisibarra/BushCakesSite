...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<link rel="stylesheet" href="css/bushcakes.css">
	...
	<body>
		...
		<div id="fh5co-main" style="margin-top: 185px">
				...
				<div class="row">
					...
					<div class="col-md-4" style="padding-left: 0px; margin-bottom: 5px">
						<div class="animate-box">
							<a href="http://order.carlosbakery.com">
								<img src="http://placehold.it/300x238" alt="Order Online, Pick Up In-store" title="Order Online, Pick Up In-store">
							</a>
						</div>
					</div>
					...
					<form class="form-inline">
						<div class="row">
							<div class="form-group col-md-10">
								<label for="exampleInputEmail2" style="font-size: 15px; color: #2d9c9b; font-weight: 300">Suscribete para obtener informacion de eventos y noticias</label>
								<input type="email" class="form-control" id="exampleInputEmail2" placeholder="jane.doe@example.com">
							</div>
							<div class="col-md-2">
								<button type="submit" class="btn btn-default" style="margin-bottom: 0px">Enviar</button>
							</div>
						</div>
					</form>
				</div>
			...
			<div class="fh5co-cards" style="padding-top: 3em">
